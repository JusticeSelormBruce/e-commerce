...
<body>
  ...
  <section class="order_details section-margin--small">
	...
	if(isset($_POST['submit'])){
		...
		$query = "INSERT INTO payment (amount, paywith,	operator, telephone, zip) VALUES ('" . $amount . "', '" . $by . "','" . $operator . "', '" . $number . "', '" . $zip . "')";
	...
	if(!$result){
		...
		?>	
	   <meta http-equiv="refresh" content="5;url= ../momo.php" />

		<?php } else {
			
			print "<div class='alert-success col-md-12 text-center'>
			<span class='closebtn' onclick='this.parenoperatorement.style.display='none';'>&times;</span>
