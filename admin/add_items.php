    ...
    <!-- left side start-->
		<div class="left-side sticky-left-side">
			...
			<div class="left-side-inner">
				...
				<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li class="active"><a href="add_items.php"><i class="fa fa-plus-square"></i> <span>Add Product</span></a></li>   
		...
		<!-- //header-ends -->
			...
			<div id="page-wrapper">
				...
				<h3 class="blank1">Add New Product </h3>
						<div class="tab-pane active" id="horizontal-form">

							<form class="form-horizontal"  method="post" action="Controllers/add-product.php" enctype="multipart/form-data">

								<div class="form-group">
								<label for="focusedinput" class="col-sm-2 control-label"><strong style="color:red">Add New Product </strong></label>
								
								</div>
								<div class="form-group">
							
									<div class="col-sm-5">
										<input type="text" class="form-control1" name="id" hidden="true">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control1" name="code"  placeholder="Produc Code">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control1"  name="name"  placeholder="Product Name">
									</div>
								</div>
								<div class="form-group">
									<label for="txtarea1"  class="col-sm-2 control-label">Description</label>
									<div class="col-sm-5"><textarea  name="descript" id="txtarea1" cols="100" rows="10" name="descript" class="form-control1" placehoder="Product Description"></textarea></div>
								</div>
								<div class="form-group">
									<label for="inputPassword" class="col-sm-2 control-label">Product Brand</label>
									<div class="col-sm-5">
										<input type="text" class="form-control1"  name="brand"  placeholder="Product Brand ">
									</div>
								</div>
								<div class="form-group">
									<label for="inputPassword" class="col-sm-2 control-label">Category</label>
									<div class="col-sm-5">
										<input type="text" class="form-control1"  name="category"  placeholder="Category eg. Electronics">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<input type="text" class="form-control1" name="size"  placeholder="Size">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<input type="text" class="form-control1" name="color" placeholder="Color">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
									<select name="overall"  class="form-control1" >
								...
								<div class="form-group">
											...
											<div class="col-sm-3">
												<input type="number" class="form-control1"  name="unit" placeholder="Units">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<input type="number" class="form-control1" name="new_price" placeholder="New Price">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<input type="number" class="form-control1" name="old_price" placeholder="Old Price">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<input type="number" class="form-control1" name="fees" placeholder="Shipping Fees">
									</div>
									
								</div>
								
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label" style="color:red;">Product Images</label>
								...
								<label for="focusedinput" class="col-sm-2 control-label" >Front View</label>
									...
									<div class="col-sm-3">
										<input type="file" class="form-control1" name="image1" required="true">
									</div>
								...
								<label for="focusedinput" class="col-sm-2 control-label" >Back View</label>
									...
									<div class="col-sm-3">
										<input type="file" class="form-control1" name="image" required="true">
									</div>
								...
								<label for="focusedinput" class="col-sm-2 control-label" >Others</label>
									...
									<div class="col-sm-3">
										<input type="file" class="form-control1" name="imag" required="true">
									</div>
								...
								<div class="col-sm-8 col-sm-offset-2">
									...
									<input type="submit" name="add" class="btn-success btn" value="Add Product">
									<a href="dashboard.php"class="btn-default btn" > Back</a>
