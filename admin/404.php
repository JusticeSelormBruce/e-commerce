			...
			<div class="left-side-inner">
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						<li ><a href="dashboard.php"><i class="lnr lnr-power-switch"></i><span>Dashboard</span></a></li>
						
					
						<li><a href="items.php"><i class="lnr lnr-menu"></i> <span>Items</span></a></li>    
						<li class="active"><a href="add_items.php"><i class="lnr lnr-select"></i> <span>Add Product</span></a></li>   
						<li><a href="orders.php"><i class="lnr lnr-list"></i> <span>Orders</span></a></li>   
