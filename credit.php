...
<br>
                <div class="col-lg-8">
                <marquee behavior="alternate" scrollamount="20" style="font-size:30px; color:red;"><strong>Card Payment Plan</strong>  </marquee>
                    ...
                    <div class="col-md-12">
                     ...
                     <br>
                     <a href="#" class="button button-postComment button--active" data-toggle="modal" data-target="#exampleModalcard">Make Payment</a>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h6 class="modal-title text-uppercase text-center" id="exampleModalLongTitle"><strong style="color:red">Banking Card Details Required For Payment</strong></h6>
    ...
    <div class="modal-body">
		...
		<div class="container">
            ...
            <form class="row contact_form" action="payment/credit_submit.php" method="post">
                   
                   <input type="text" class="form-control" id="last" name="amount" required="true" hidden="true" value="<?php echo $currency .  $grandtotal . $dec ?>">
                    <input type="text" class="form-control" id="by" name="by" required="true" hidden="true" value="Credit Card">
       

                   <div class="col-md-12 form-group p_star">
                           <select class="country_select" name="cardtype">
                       ...
                       <div class="col-md-12 form-group p_star">
                           <input type="text" class="form-control" id="number" name="number" placeholder="Card Number" required="true">
           
                       </div>
                       
                       <div class="col-md-12 form-group p_star">
                           <input type="text" class="form-control" id="add1" name="cvv" placeholder="CVV Number" required="true">
                    
                       </div>
                      
                       <div class="col-md-12 form-group p_star">
                           <input type="date" class="form-control" id="expirydate" name="expirydate" placeholder="Expiry Date" required="true">
