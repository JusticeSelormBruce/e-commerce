  ...
  foreach($_SESSION['cart'] as $product_id => $quantity) {
    ...
    if($result){
      ...
      if($obj = $result->fetch_object()) {
        ...
        $query = $mysqli->query("INSERT INTO orders (product_code	,product_name, product_desc, product_img_name,	price	,units,	total,	email) VALUES('$obj->product_code', '$obj->product_name', '$obj->product_desc', '$obj->product_img_name', $obj->price, $quantity, $cost, '$email')");
